      ...
      <section id="about" className="bg-background">
        <div className="mx-auto grid max-w-7xl gap-16 px-6 py-24 md:grid-cols-12 md:px-10 md:py-32">
          ...
          <div className="space-y-8 text-[17px] leading-loose text-ink/85 md:col-span-7">
            <p>
              עו״ד איריס בודנהיימר היא בעלת ניסיון של כ־38 שנים בתחום המשפט המסחרי
              והעסקי, וליוותה לאורך שנותיה מאות חברות, בעלי עסקים ומשפחות בקבלת
              החלטות מורכבות, ניהול משברים ופתרון סכסוכים.
            </p>
            <p>
              לשעבר היועצת המשפטית ומזכירת החברה של קבוצת הריבוע הכחול. בעלת תואר
              LL.B מאוניברסיטת תל אביב ו־MBA מתוכנית רקנאטי–קלוג.
            </p>
            <p>
