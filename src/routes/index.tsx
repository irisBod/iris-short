...
const practiceAreas = [
  ...
  {
    n: "02",
    title: "עסקים משפחתיים, צוואות, ירושות וייפוי כוח מתמשך",
    lead: "כאשר משפחה, כסף ועסק נפגשים — נדרש יותר מייעוץ משפטי.",
    items: [
      "העברת עסק לדור הבא",
      "מניעת סכסוכים בין בני משפחה",
      "הסכמים משפחתיים",
      "צוואות (כולל צוואות בינלאומיות)",
      "סכסוכי ירושה בינלאומיים",
      "גישורי משפחה עסקיים",
      "גישורים בין דוריים",
    ],
  },
  ...
  {
    n: "04",
    title: "גישורים ויישוב סכסוכים",
    lead: "גישור מאפשר לצדדים לעצב בעצמם את ההסכמות, תוך חיסכון בזמן ובעלויות.",
    items: [
      "גישור מסחרי",
      "גישור משפחתי ועסקי",
      "גישור בין דורי",
      "גישור בסכסוכי שותפות",
      "גישור בסכסוכי ירושה",
